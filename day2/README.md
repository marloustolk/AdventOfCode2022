...
Appreciative of your help yesterday, one Elf gives you an **encrypted strategy guide** ([your puzzle input](./input2.txt)) that they say will be 
...
a single round is the score for the **shape you selected** (1 for Rock, 2 for Paper, and 3 for Scissors) plus the score for the **outcome of the 
...
Following the Elf's instructions for the second column, **what would your total score be if everything goes exactly according to your strategy
guide?**
