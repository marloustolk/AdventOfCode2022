...
Unfortunately, that Elf didn't quite follow 
...
The Elves have made a list of all of the items currently in each rucksack ([your puzzle input](./input3.txt)), but they need your help finding the 
errors. Every 
...
of three Elves, the badge is the **only item type carried by all three Elves**. That is, if a group's badge is item type B, then all three Elves 
will have item type B somewhere in their rucksack, and at most two of the Elves will be carrying any other item type.
